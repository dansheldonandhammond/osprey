...
autoRotateSlides() {
  ...
  this.sliderItems[currentIndex].classList.remove('active');
  this.sliderItems[nextIndex].classList.add('active');
...
setSlideVisibility() {
  this.sliderItems.forEach((item, index) => {
    item.classList.toggle('active', index === this.currentPage - 1);
  });
}
